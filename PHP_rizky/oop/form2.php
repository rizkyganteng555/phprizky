...
<div class="card mt-5 ml-5 mr-5">
    ...
    <div class="card-body">
        <form method="post" action="">
            ...
            <div class="form-group">
                <label for="exampleInputName2">Tanggal Lahir Ayah </label>
                <input type="date" class="form-control" name="tanggal_lahir_ayah" id="exampleInputName2">
            </div>
            <div class="form-group">
                <label for="exampleInputDate">Nama Ibu</label>
                <input type="name" class="form-control" name="nama_ibu" id="exampleInputDate">
            </div>
            <div class="form-group">
                <label for="exampleInputName2"> Tanggal Lahir Ibu</label>
                <input type="date" class="form-control" name="tanggal_lahir_ibu" id="exampleInputName2">
            </div>
